...
parser.add_argument('--train_path', type=str, help='Specify the path to the train csv file.', default='../dataset/trainNI')
parser.add_argument('--test_path', type=str, help='Specify the path to the test csv file.', default='../dataset/valNI')
