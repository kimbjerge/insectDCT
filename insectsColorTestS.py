...
# Load a model
model = YOLO('/home/don/insectsDCT/runs/detect/insects5Color11s/weights/best.pt')  # load a pretrained model (recommended for training)
...
file = open('detectTestColorS.csv', 'w')
