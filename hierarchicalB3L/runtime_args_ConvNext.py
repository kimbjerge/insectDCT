...
parser.add_argument('--model_test_path', type=str, help='Specify the path where for the model to test.', default='./saved_128_ConvNextV5/')
...
parser.add_argument('--model', type=str, help='Specify the model type (RestNet50, ConvNextBase).', default='ConvNextBase')
...
parser.add_argument('--model_save_path', type=str, help='Specify the path to save the model.', default='./saved_ConvNextV5/')
...
parser.add_argument('--epoch', type=int, help='Specify the number of epochs for the training.', default=80) # 30
