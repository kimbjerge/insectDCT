...
def plotTrackCrops(pathToRecordData, pathToDestCrops, trackDate, trackId, taxa, trackRows):
...
def calcConfidence(trackRows):
    ...
    confidence = 100*maximum/(counts+1) # Newer version not +1
...
def saveTrackCrops(pathToRecordData, pathToDestCrops, trackDate, trackId, trackRows):
    ...
    if confidence >= validTrackConfidence:
        plotTrackCrops(pathToRecordData, pathToDestCrops, trackDate, trackId, taxa, trackRows)
