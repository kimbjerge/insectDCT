...
def loadAllDetectionFiles(trapPathAll, trapNameAll, taxaSure=True, vegetation=False):
    ...
    if taxaSure:
        ...
        selDataset1 = dataset
    if not vegetation:
        #selDataset1 = selDataset1.loc[selDataset1['taxaLabel'] != "Coleoptera"]
        #selDataset1 = selDataset1.loc[selDataset1['taxaLabel'] != "Diptera"]
        #selDataset1 = selDataset1.loc[selDataset1['taxaLabel'] != "Snails"]
        #selDataset1 = selDataset1.loc[selDataset1['taxaLabel'] != "Aranaea"]
        selDataset2 = selDataset1.loc[selDataset1['taxaLabel'] != "Vegetation"]
    else:
        selDataset2 = selDataset1
...
if __name__ == '__main__':
    ...
    trapPath = "O:/Tech_TTH-KBE/NI_2/Data_2020/taxonCSV"
    
    selDataset = loadAllDetectionFiles(trapPath, trapNamesAll)
    plotHistogram("All NI2 demonstration sites 2020", selDataset, figsize=(14,14))
