...
if __name__=='__main__':
    ...
    parser.add_argument('--confidence', default='0.05', type=float) # insect3Color best F1-score 0.93
    ...
    parser.add_argument('--frame_stride', default='3', type=int) # for video, not used for images 2 fps
