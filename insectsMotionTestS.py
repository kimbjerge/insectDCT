...
# Load a model
model = YOLO('/home/don/insectsDCT/runs/detect/insects5Motion11s/weights/best.pt')  # load a pretrained model (recommended for training)
...
file = open('detectTestMotionS.csv', 'w')
...
for testName in testNames:
    ...
    results = model.val(data=yamlFile, batch=16, imgsz=1920, device=0, show=False, name=testName+'S')
